#
# Be sure to run `pod lib lint OnboardFlow.podspec' to ensure this is a
...
OnboardFlow is a Swift library helping you create simple onboarding flows. It gives a simple logic and some customization on how you want your users to navigate your onboarding
  ...
  s.author           = { 'johnoppenheimer' => 'maximecattet@gmx.com' }
  s.source           = { :git => 'https://github.com/johnoppenheimer/OnboardFlow.git', :tag => s.version.to_s }
  ...
  # s.resource_bundles = {
  #   'OnboardFlow' => ['OnboardFlow/Assets/*.png']
  # }
